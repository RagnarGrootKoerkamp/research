...
#+hugo_aliases: /2021/07/02/wayland/
#+toc: headlines 0
#+date: <2021-07-02>
...
* Terminal emulator: =foot=
    ...
    :END:
[[file:TODO][Foot]] is the default terminal emulator in Sway and has
...
- [[https://chrome.google.com/webstore/detail/vimium/dbepggeogbaibhgnhhndojpepiihcmeb][Vimium]]
  for vim-like browsing. My config is [[file:%7B%%20post_url%20/linux/vimium/2021-07-02-vimium%20%%7D][here]].
