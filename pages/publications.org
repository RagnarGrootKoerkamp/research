...
- PtrHash preprint ([[file:~/git/eth/research/static/papers/ptrhash-full.pdf][PDF]]) :: [cite/bibentry/b:@ptrhash-full]
- U-index preprint ([[file:~/git/eth/research/static/papers/u-index-preprint.pdf][PDF]]) :: [cite/bibentry/b:@u-index-preprint]
- Simd-minimizers preprint ([[file:../static/papers/simd-minimizers-preprint.pdf][PDF]]) :: [cite/bibentry/b:@simd-minimizers-preprint]
