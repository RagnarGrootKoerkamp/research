...
#+REVEAL_TITLE_SLIDE: <h2 class="date">RECOMB-Seq 2026, Thessaloniki<br/>IGGSy 2026, Ascona</h2>
...
# UPDATE
#+reveal_slide_footer: <span class="date">RECOMB-Seq 2026</span> <span class="title">Rick Beeloo & Ragnar Groot Koerkamp: Sassy 1 & 2</span> <img class="uu-logo" src="/images/uu.png"></img> <img class="eth-logo" src="/images/ethz.svg"> <img class="kit-logo" src="/images/kit.png">
...
* Previously
#+attr_html: :class full :style left:30%;top:0%;max-width:70%;border:1px solid black;z-index:20 :src /ox-hugo/astarpa-scrot.png
[[file:./scrots/astarpa-scrot.png]]
#+attr_html: :class full :style left:10%;top:26%;z-index:10;max-width:90% :src /ox-hugo/astarpa-flames.png
[[file:./scrots/astarpa-flames.png]]


* Previously
:PROPERTIES:
:CUSTOM_ID: previously-2
:END:
#+attr_html: :class full :style left:30%;top:0%;max-width:70%;border:1px solid black;z-index:20 :src /ox-hugo/astarpa-scrot.png
[[file:./scrots/astarpa-scrot.png]]

#+attr_html: :class full :style left:32%;top:2%;max-width:70%;border:1px solid black;z-index:40 :src /ox-hugo/astarpa2-scrot.png
[[file:./scrots/astarpa2-scrot.png]]
#+attr_html: :class full :style top:29%;z-index:30 :src /ox-hugo/astarpa-flames2.png
[[file:./scrots/astarpa-flames2.png]]

* Long-read global alignment is just not a problem people have...
* ... Sassy: 100bp semi-global alignment

* Takeaway 1: Math yay, Bio nay
* Takeaway 2: Do simple stuff fast 
