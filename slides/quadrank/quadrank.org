...
#+attr_html: :src /ox-hugo/1-linear.svg :style width:100%;margin-bottom:-5%
[[file:./figs/1-linear.svg]]

- Precompute all 64-bit answers $r_i := \rank(i)$: 
  - $O(1)$ time, $64\times$ overhead.

#+attr_html: :src /ox-hugo/2-precompute.svg :style width:100%
...
#+attr_html: :src /ox-hugo/3-blocks.svg :style width:100%;margin-bottom:-2%
...
#+attr_html: :src /ox-hugo/4-pasta.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:10%;position:absolute
...
#+attr_html: :src /ox-hugo/5-spider.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:10%;position:absolute
...
#+attr_html: :src /ox-hugo/6-pairing.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:10%;position:absolute
...
#+attr_html: :src /ox-hugo/7-birank.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:10%;position:absolute
...
:END:
#+attr_html: :class full :src /ox-hugo/plot-laptop-st-2-large.svg :style left:-1%
...
#+attr_html: :src /ox-hugo/8-quadrank.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:0%;position:absolute
...
:END:
#+attr_html: :class full :src /ox-hugo/plot-laptop-st-4-large.svg :style left:9%
...
:END:
#+attr_html: :class full :src /ox-hugo/plot-fm.svg :style left:3%
