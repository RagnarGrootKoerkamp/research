...
#+export_file_name: quadrank-text
#+reveal_export_file_name: ../../static/slides/quadrank/index.html
...
#+REVEAL_TITLE_SLIDE: <h1 class="title">QuadRank</h1>
...
#+REVEAL_TITLE_SLIDE: <h2 class="date" style="font-size:smaller;font-weight:normal;color:grey">DSB 2026, SEA 2026</h2>
#+REVEAL_TITLE_SLIDE: <a href="https://doi.org/10.4230/LIPIcs.SEA.2026.20" style="position:absolute;bottom:15%%;left:3%%;width:30%%;color:grey;font-size:smaller">doi.org/10.4230/LIPIcs.SEA.2026.20</a>
#+REVEAL_TITLE_SLIDE: <a href="https://curiouscoding.nl/posts/quadrank" style="position:absolute;bottom:10%%;left:3%%;width:30%%;color:grey;font-size:smaller">curiouscoding.nl/{posts,slides}/quadrank</a>
#+REVEAL_TITLE_SLIDE: <a href="https://github.com/RagnarGrootKoerkamp/quadrank" style="position:absolute;bottom:5%%;left:3%%;width:30%%;color:grey;font-size:smaller">github.com/RagnarGrootKoerkamp/quadrank</a>
...
#+attr_html: :class full post-large :src /ox-hugo/rank-overview.svg :style background:white
...
#+attr_html: :src /ox-hugo/1-linear.svg :style width:100%;margin-bottom:-5% :class post-large
[[file:./figs/1-linear.svg]]

- Precompute all 64-bit answers $r_i := \rank(i)$: 
  - $O(1)$ time, $64\times$ overhead.

#+attr_html: :src /ox-hugo/2-precompute.svg :style width:100% :class post-large
[[file:./figs/2-precompute.svg]]
...
#+attr_html: :src /ox-hugo/3-blocks.svg :style width:100%;margin-bottom:-2% :class post-large
[[file:./figs/3-blocks.svg]]
- Query $q = j\cdot B + q'$:
...
#+attr_html: :src /ox-hugo/4-pasta.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:20%;position:absolute :class post-large
[[file:./figs/4-pasta.svg]]
...
#+attr_html: :src /ox-hugo/5-spider.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:20%;position:absolute :class post-large
[[file:./figs/5-spider.svg]]

* Reducing the popcount: Pairing
:PROPERTIES:
:CUSTOM_ID: pairing
:END:
- [cite/t:@engineering-rank]
- Delta is to the /middle/ instead of /start/ of a block.
  - Count only 256 bits in first or second half of block.

#+attr_html: :src /ox-hugo/6-pairing.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:20%;position:absolute :class post-large
[[file:./figs/6-pairing.svg]]

* All together now: BiRank
:PROPERTIES:
:CUSTOM_ID: birank
:END:
- Inline 16-bit deltas from SPIDER [cite:@spider]
- Pairing from [cite/t:@engineering-rank]
...
#+attr_html: :src /ox-hugo/7-birank.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:15%;position:absolute :class post-large
[[file:./figs/7-birank.svg]]
...
for i in 0..queries.len() {
    ranker.prefetch_index(queries, i+32);
...
:END:
#+attr_html: :class full post-large :src /ox-hugo/plot-laptop-st-2-large.svg :style left:-1%;height:100%
...
* QuadRank: BiRank for $\sigma{=}4$ DNA
:PROPERTIES:
:CUSTOM_ID: quadrank
:END:
- New rank query $\rank(q, c)$ for arbitrary $c$ and
  ...
  - 16 MiB cache supports 14 GiB = 61 Gbp input

#+attr_html: :src /ox-hugo/8-quadrank.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:0%;position:absolute :class post-large
[[file:./figs/8-quadrank.svg]]

* QuadRank
:PROPERTIES:
:CUSTOM_ID: quadrank-results
:END:
#+attr_html: :class full post-large :src /ox-hugo/plot-laptop-st-4-large.svg :style left:9%
...
:END:
#+attr_html: :class full post-large :src /ox-hugo/plot-fm.svg :style left:14%
...
#+attr_html: :class plot post-large :src /ox-hugo/sassy2-results.svg
