...
#+hugo_section: posts/quadrank-slides
...
#+REVEAL_TITLE_SLIDE: <a href="https://doi.org/10.48550/ARXIV.2602.04103" style="position:absolute;bottom:15%%;left:3%%;width:30%%;color:grey;font-size:smaller">doi.org/10.48550/ARXIV.2602.04103</a>
...
#+attr_html: :src /ox-hugo/4-pasta.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:10%;position:absolute :class post-large
...
#+attr_html: :src /ox-hugo/5-spider.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:10%;position:absolute :class post-large
...
#+attr_html: :src /ox-hugo/6-pairing.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:10%;position:absolute :class post-large
...
#+attr_html: :src /ox-hugo/7-birank.svg :style width:120%;max-width:150%;margin-left:-25%;bottom:10%;position:absolute :class post-large
...
:END:
#+attr_html: :class full post-large :src /ox-hugo/plot-laptop-st-2-large.svg :style left:-1%
...
:END:
#+attr_html: :class full post-large :src /ox-hugo/plot-fm.svg :style left:3%
