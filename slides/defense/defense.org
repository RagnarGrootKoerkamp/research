...
#+REVEAL_TITLE_SLIDE: <a href="https://curiouscoding.nl/defense" style="position:absolute;bottom:6.8%%;right:1%%;width:30%%;color:grey;font-size:smaller">curiouscoding.nl/slides/defense</a>
