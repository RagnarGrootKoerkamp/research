...
#+attr_html: :class float :src /ox-hugo/tree-example.png
...
#+attr_html: :class float-right :style max-height:40%;top:55%;right:15% :src /ox-hugo/tree-example.png
[[file:./tree-example.png]]
...
#+attr_html: :class float-right :style max-height:70%;top:0%;right:00% :src /ox-hugo/tree-example.png
[[file:./tree-example.png]]
...
#+attr_html: :class float-right :style max-height:50%;top:0%;right:00% :src /ox-hugo/tree-example.png
[[file:./tree-example.png]]
...
#+attr_html: :class float-right :style max-height:50%;top:45%;right:05% :src /ox-hugo/tree-example.png
[[file:./tree-example.png]]
...
#+attr_html: :class float-right :style max-height:50%;top:10%;right:00% :src /ox-hugo/tree-example.png
[[file:./tree-example.png]]
...
#+attr_html: :class float-right :style max-height:40%;top:10%;right:00% :src /ox-hugo/tree-example.png
[[file:./tree-example.png]]
...
- Parent of $u$: get preceding ), then matching (, then succeeding ):
...
#+attr_html: :class float-right :style max-width:50%;height:70% :src /ox-hugo/succinct-planar-graph.png
[[file:./succinct-planar-graph.png]]
...
# #+attr_html: :class blackboard :src /ox-hugo/blackboard-succinct-trees-1.jpg
# [[file:./blackboard-succinct-trees-1.jpg]]
# * Blackboard: Select & Darray
# #+attr_html: :class blackboard :src /ox-hugo/blackboard-succinct-trees-2.jpg 
# [[file:./blackboard-succinct-trees-2.jpg]]
