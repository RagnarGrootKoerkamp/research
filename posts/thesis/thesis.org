...
This post contains the abstract, introduction, and conclusion of my thesis [cite:@thesis].
The full PDF is [[../../static/thesis.pdf][here]].
Individual chapters are based on blog posts and/or papers and introduced in
detail in the introduction below. In brief:

- Introduction: this post

- Part 1: Pairwise Alignment
  - Chapter 2: A History of Pairwise Alignment ([[../pairwise-alignment/pairwise-alignment.org][blog]])
  - Chapter 3: A*PA ([[../../static/papers/astarpa.pdf][PDF]])
  - Chapter 4: A*PA2 ([[../astarpa2/astarpa2.org][blog]], [[../../static/papers/astarpa2.pdf][PDF]])
  - Chapter 5: Semi-Global Alignment and Mapping ([[../mapping/mapping.org][blog]])

- Part 2: Low Density Minimizers ([[../minimizers/minimizers.org][blog]])
  - Chapter 6: Theory of Sampling Schemes
  - Chapter 7: Lower Bounds on Sampling Scheme Density
  - Chapter 8: Practical Sampling Schemes
  - Chapter 9: Towards Optimal Sampling Schemes
  
- Part 3: High Throughput Bioinformatics
  - Chapter 10: Optimizing Throughput ([[../throughput/throughput.org][blog]])
  - Chapter 11: SimdMinimizers ([[../simd-minimizers/simd-minimizers.org][blog]])
  - Chapter 12: PtrHash ([[../ptrhash/ptrhash.org][blog]])
...
- SimdMinimizers [cite:@simd-minimizers]: :: Ragnar Groot Koerkamp and
...
- PtrHash [cite:@ptrhash]: :: Ragnar Groot Koerkamp, /PtrHash: Minimal
...
- U-index [cite:@u-index]: :: Lorraine A. K. Ayad, Gabriele Fici,
