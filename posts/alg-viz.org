...
#+filetags: @ideas highlight text-indexing visualization data-structure
#+OPTIONS: ^:{}
...
Suffix-array construction is explained [[file:suffix-array-construction/suffix-array-construction.org][here]] and BWT is explained [[file:bwt/bwt.org][here]].
