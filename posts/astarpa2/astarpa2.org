...
| [[file:intro/0_full.png]] Full grid (NW) | [[file:intro/0_gap-start.png]] gap heuristic                       | [[file:intro/0_gap-gap.png]] gap-gap (ukkonen)    |                                           |
|                                      | [[file:intro/0_g.png]] g*                                          | [[file:intro/0_g-gap.png]] g*+gap (edlib)         | [[file:intro/5_astarpa.png]] g*+h (A*PA)      |
|                                      | [[file:intro/2_dijkstra.png]] Dijkstra                             | [[file:intro/6_astarpa2_simple.png]] A*PA2-simple | [[file:intro/7_astarpa2_full.png]] A*PA2-full |
|                                      | [[file:intro/3_diagonal-transition.png]] Diagonal transition (WFA) |                                               |                                           |
...
| [[file:intro/0_g-gap.png]] g-gap | [[file:intro/0_bitpacking.png]] myers bitpacking (Edlib) | [[file:intro/0_blocks.png]] Blocks (Block aligner) |
...
| [[file:prepruning/csh.png]]    | [[file:prepruning/csh-p.png]]    |
| [[file:prepruning/csh-lp.png]] | [[file:prepruning/csh-lp-p.png]] |
...
| [[file:prepruning/sh.png]]    | [[file:prepruning/sh-p.png]]    | [[file:prepruning/csh.png]]    | [[file:prepruning/csh-p.png]]    | [[file:prepruning/gcsh.png]]    | [[file:prepruning/gcsh-p.png]]    |
| [[file:prepruning/sh-lp.png]] | [[file:prepruning/sh-lp-p.png]] | [[file:prepruning/csh-lp.png]] | [[file:prepruning/csh-lp-p.png]] | [[file:prepruning/gcsh-lp.png]] | [[file:prepruning/gcsh-lp-p.png]] |
...
#+attr_html: :class inset large
[[./results/real-summary-scatter.svg]]
...
#+attr_html: :class inset large
[[./results/real-ablation.svg]]
*** Real data parameters
#+name: params
#+caption: Varying parameters.
#+attr_html: :class inset large
[[./results/real-params.svg]]
*** Memory usage
...
#+attr_html: :class inset large
[[./results/real-timing.svg]]
** Synthetic data
*** Scaling with divergence
#+name: scaling-e
#+caption: Scaling with error rate
#+attr_html: :class inset large
[[./results/scaling_e.svg]]

** TODO
- Bench the new profile
  - Hmm code is not compatible with old profile...
- Visualizations
  - Methods
    - incremental doubling detail

*** WONTFIX/too complicated/maybe later
- Sparse heuristic detail?
- SIMD-gif
- A*PA2-gifs
