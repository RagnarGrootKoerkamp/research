...
#+name: scaling-n-0.05
#+caption: Scaling with length 5%
#+attr_html: :class inset large
[[./scaling_n_e0.05.svg]]
#+name: scaling-n-0.15
#+caption: Scaling with length 15%
#+attr_html: :class inset large
[[./scaling_n_e0.15.svg]]
...
** TODO
- Band/number of computed states?
- Dataset statistics
- Memory usage (human & synthetic)
- runtime distribution real&synthetic
  - precomputation
  - computing blocks
  - traceback
    - dt trace
