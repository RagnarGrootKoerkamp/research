...
instructions (see [[*BitPAl bitpacking]]) we did not pursue this further.
...
#+name: myers
#+caption: Rust code for SIMD version of Myers' bitpacking. Computes four independent words on an antidiagonal in parallel in $20$ instructions.
#+begin_src rust
