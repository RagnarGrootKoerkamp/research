#+title: PtrHash: Notes on adapting PTHash in Rust
#+filetags: @lablog mphf hpc highlight
#+OPTIONS: ^:{}
...
A paper on PtrHash can be found in this [[../ptrhash/ptrhash.org][post]], and published as ([[../../static/papers/ptrhash.pdf][PDF]]):
