...
This means that the delete-open and delete-extend edges become $\Delta_D$ more
expensive, and similarly the insert-open and insert-extend edges become $\Delta_I$ more
expensive.
