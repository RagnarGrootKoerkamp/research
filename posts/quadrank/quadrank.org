...
generate 10 million random query positions.
...
query, which we will just call throughput) when processing the random queries in
...
# - EXPLAIN SEQUENTIAL=LATENCY vs LOOP~BATCH vs PREFETCH and ILP
# - add 'Space overhead' header to fig
# ** code
# TODO:
...
#   u32x4 for =sign=.
# - bench sview: https://crates.io/crates/sview-fmindex
