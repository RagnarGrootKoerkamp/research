...
results in a smaller size and up 4$\times$ speedup over Genedex, a state-of-the-art batching
...
These results also translate to up to 4$\times$ speedups when used in an FM-index,
