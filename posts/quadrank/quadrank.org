...
* TODO QuadFm: A Batching FM-index
:PROPERTIES:
:CUSTOM_ID: fm-index
:END:

To showcase an application of our high-throughput data structure, we develop a
toy implementation QuadFm[fn::https://github.com/RagnarGrootKoerkamp/quadrank/blob/master/fm-index/src/quad_fm.rs] of an FM-index for the $\sigma=4$ DNA alphabet.
