#+title: Bitpacking and approximate string matching
#+date:  <2023-08-11>
#+hugo_level_offset: 1
#+hugo_front_matter_key_replace: author>authors
#+options: ^:{}
#+filetags: @survey pairwise-alignment bitpacking wip highlight
#+toc: headlines 3
...
Part of this post has been integrated in the introduction of the Sassy paper [cite:@sassy-preprint].
...
PDF [[file:../../static/papers/hyyro04-revisited.pdf][here]], because it's impossible to find.
