...
See also the paper on anti-lexicographic SUS-anchors that came out of this: [[https://doi.org/10.48550/arXiv.2606.01190][DOI]], [[../../static/papers/sus-anchor.pdf][PDF]]:

#+begin_quote
[cite/bibentry/b:@sus-anchor]
#+end_quote
...
- In [cite/t:@greedymini], it seems that also for $k=w$ and generally
