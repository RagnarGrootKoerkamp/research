...
#+name: comparison
#+caption: Comparison [TODO] $n=3\cdot 10^8$
...
| PTHash-HEM C-C                     |       4.0 |     0.99 |                          3.16 |                                     173 |                           77 |
| PTHash-HEM EF                      |       5.0 |     0.99 |                          2.17 |                                     323 |                          156 |
...
|                                    |           |          |                               |                                         |                              |
| PtrHash fast: Vec, streaming       |       3.0 |     0.99 |                          2.99 |                                    *27* |                         *20* |
| PtrHash compact: CLEF streaming    |       4.0 |     0.99 |                          2.12 |                                      62 |                         *23* |
Remarks:
- Compared PHOBIC results:
  - ~2x slower queries, because 1y older CPU and pinned CPU frequency
  - Omitted
