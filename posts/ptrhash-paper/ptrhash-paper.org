...
This continues the line of work started by PTHash [cite:@pthash;@pthash-2] and
continued by PHOBIC [cite:@phobic], that both provide relatively fast queries.
...
To end, applications could investigate whether they can be rewritten to
stream queries.
