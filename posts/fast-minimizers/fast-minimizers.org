...
#+include: "code/blog/ringbuf.rs" src rust :lines "1-34"
...
#+include: "code/blog/queue.rs" src rust :lines "2-"
...
@@html:<details><summary>Click to show code</summary>@@
...
** TODO Runtime comparison with other implementations
...
#+caption: Runtime comparison between our and other's implementations. TODO: more params, 10^6 text length.
#+begin_src txt
...
| =QueueIgor=    |               7.1 |                     2.33 |                  662 |           4.29% |
| =Jumping=      |                14 |                     3.89 |                 1459 |           0.13% |
| =Rescan=       |                14 |                     3.02 |                 1116 |           2.26% |
| =RescanDaniel= |                27 |                     3.21 |                 1410 |           0.85% |
| =Split=        |               9.0 |                     3.37 |                 1116 |           1.55% |
...
#+caption: Split the =RingBuf= into two slices, such that the element of the first returned slice come before the second part.
#+include: "code/blog/ringbuf.rs" src rust :lines "42-48"
...
@@html:<details><summary>New assembly</summary>@@
