...
in the right figure.[fn::The animated SVG figures are generated using the [[https://github.com/RagnarGrootKoerkamp/research/blob/master/posts/diamond-optimization/generate_wfa_svg.c][C-code]]
