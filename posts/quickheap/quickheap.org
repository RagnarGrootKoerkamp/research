#+title: QuickHeap: the fastest priority queue
#+filetags: @paper hpc data-structure software
#+OPTIONS: ^:{} num: num:1
...
*Backlinks*: [[https://bsky.app/profile/curiouscoding.nl/post/3mko6y5k2f22w][bsky]], [[https://x.com/curious_coding/status/2049441073718518046][X]], [[https://news.ycombinator.com/item?id=47994575][hacker news]], [[https://lobste.rs/s/85wpyb/quickheap_fastest_comparison_based_heap][lobste.rs]]

A preprint on the SimdQuickHeap ([[https://github.com/ragnargrootkoerkamp/quickheap][github:RagnarGrootKoerkamp/QuickHeap]]) with the latest results can now be found on arXiv ([[https://doi.org/10.48550/ARXIV.2604.25681][DOI]], [[../../static/papers/simdquickheap-preprint.pdf][PDF]]):

#+begin_quote
Johannes Breitling, Ragnar Groot Koerkamp, Marvin Williams. 2026. \\
"SimdQuickHeap: The QuickHeap Reconsidered". \\
Arxiv. https://doi.org/10.48550/ARXIV.2604.25681
#+end_quote

This post was originally written in August 2025 and contains some more
background, initial ideas, and (slightly outdated) results.
...
See the full paper for more: [cite/t:@simdquickheap-preprint].
