...
Below, we present two direct methods for computing the /maximal/ suffix, as this
slightly simplifies the notation and matches [cite:@minimal-maximal-suffix-tcs].
...
mod-minimizer [cite:@modmini], especially in order to remove the mod-minimizer's $r$ parameter,
