...
TODO:
- Weak vs strong prefetching; see [cite:@fetch-me-if-you-can]
  - Trick: read 0-values data and add is to get a data-dependency
- Experiment measuring number of fill buffers
