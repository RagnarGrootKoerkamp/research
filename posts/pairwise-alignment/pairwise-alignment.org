...
| Paper                                                  | Time                                        | Space                                | Cost model                      | Method                                                          | Remarks                                                     |
|--------------------------------------------------------+---------------------------------------------+--------------------------------------+---------------------------------+-----------------------------------------------------------------+-------------------------------------------------------------|
...
| WFA: [cite:@wfa]                                       | $O(ns)$                                     | $O(n+s^2)$^{[[score-only]]}              | affine                          |                                                                 | $O(n+s^2)$ expected                                         |
| WFALM: [cite:@wfalm]                                   | $O(n+s^2)$                                  | $O(n+s^{3/2})$^{[[score-only]]}          | affine                          |                                                                 |                                                             |
| biWFA: [unpublished]                                   | $O(ns)$                                     | $O(n)$                               | affine                          |                                                                 | $O(n+s^2)$ expected                                         |
| A* pairwise aligner                                    | $O(n)$ expected                             | $O(n)$                               | unit cost                       | *A**, *seed heuristic*, *pruning*                               | only for random strings with random errors                  |
