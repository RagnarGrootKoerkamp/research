...
#+name: cost-models
#+attr_html: :class inset :width 60%
[[file:cost-models.svg]]
...
process is shown in figure [[algs-1]].
...
*Contours.* The regions of equal $S$ create a set of /contours/ ([[algs-2]]j), where contour $\ell$ is the
