...
#+caption: Overview of different alignment types. (CC0 by Pesho Ivanov, [[https://github.com/RagnarGrootKoerkamp/research/blob/master/posts/pairwise-alignment/alignment-type.drawio.svg][source]])
#+name: alignment-types
[[file:alignment-types.drawio.svg]]
...
TODO: drop LV89, but mention it somewhere, or just leave for mapping only

TODO: Write on expected runtime somewhere
