...
character (/homopolymers/), the read may report an incorrect number of characters.
...
a new type of mutation for pairwise alignment that corrects for this type of errors.
...
actual discrepancy between real and observed homopolymer lengths (eg Fig. 9 of [cite:@ont-reads-delahaye2021]).
