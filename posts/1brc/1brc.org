...
The [[code][commit]] is kinda ugly. Highlight is this function that reads the bytes in
...
(OMG It's hard to understate my happiness here :)
...
* TODO
- Parse integers using multiplication
- Remove the =-b'0'= for the hundreds digit as well.
- Try =PEXT=/=PDEP= instructions for spreading out bits.
