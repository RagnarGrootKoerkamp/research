#+TITLE: A survey of exact global pairwise alignment
#+filetags: @survey pairwise-alignment
#+OPTIONS: ^:{}
#+date: <2022-04-01 Thu>
...
This has been reworked into a thesis chapter [[../pairwise-alignment/pairwise-alignment.org][in this post]].
Please use my thesis [cite:@thesis] for citations ;)
...
- Ends-free :: Indels/gaps at the end are free. This comes in several variants.
  - Semi-global (mapping, glocal, infix) :: Align a full sequence to a substring
    of a reference.[fn::The paper introducing glocal alignment [cite:@glocal],
    actually defines that as something else...]
...
TODO: Singletrack [cite:@singletrack]
