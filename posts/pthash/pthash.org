...
This last case is interesting: we could fix a maximal $K$ up front and then find
all possible $k_i \leq K$ for all buckets. Then we find a perfect matching (if
